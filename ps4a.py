...
def getWordScore(word, n):
    ...
    scoreList = []
    for letter in word:
        letterScore = SCRABBLE_LETTER_VALUES[letter] 
        scoreList.append(letterScore)
    score = 0
    for element in scoreList:
        score += element*len(word)
    if len(word) == n:
        return score + 50
    else:
        return score
...
def updateHand(hand, word):
    ...
    newHand = hand.copy()
    for letter in word:
        letterValue = newHand[letter]
        newHand[letter] = letterValue - 1
    return newHand
    ...
    while calculateHandlen(hand) != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print("{} earned {} points. Total: {} points".format(inputWord, getWordScore(inputWord, n), totalScore))                
                print('')
    ...
    while True:
        ...
        if command == 'r':
            if hand == {}:
                ...
                playHand(copyhand, wordList, HAND_SIZE)
                print
                continue
        else:
